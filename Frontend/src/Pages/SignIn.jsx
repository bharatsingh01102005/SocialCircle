...
function SignIn() {
    ...
    rounded-2xl border-2 border-black'
                    ...
                    font-semibold h-[50px] cursor-pointer rounded-2xl mt-[30px]'
                        onClick={handlesignIn} disabled={loding}>{loding?<ClipLoader size={30} color="#ffffff" />:"Sign In"}
                        
                    </button>
                    <p className='cursor-pointer text-gray-800' onClick={()=> Navigate("/signup")}>
                        Want to create a new Account?
                        <span className='border-b-2 border-b-black pb-[3px] text-black'> Sign Up</span>
                    </p>
                </div>
